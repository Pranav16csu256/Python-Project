#NorthCap University
#Pranav Garg
#Under Guidance of Prof.Sandeep Singh
#A GUI for Customer Managment System
from tkinter import *
win=Tk()
...
def delrec():                                              #Function to delete record
...
def clear():                        #Function to clear record
    global count
    count=0 
    m=""
    s1.set(m)
...
t1=Entry(win,textvariable=s1)           #Declaration of Textboxes
...
b1=Button(win,text="add",command=addrec)               #Declaration of Buttons
...
l1.grid(row=1,column=1)                        #Using grid layout for GUI interface 
